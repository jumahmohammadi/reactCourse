    ...
    return(
        <>
           <div>
              ...
              <ul>
                <li><Link to="/post-detail/1">first title</Link></li>
                <li><Link to="/post-detail/2">second title</Link></li>
                <li><Link to="/post-detail/3">third title</Link></li>
                <li><Link to="/post-detail/4">fourth title</Link></li>
                <li><Link to="/post-detail/5">fifth title</Link></li>
              </ul>
           </div>
           <div>
